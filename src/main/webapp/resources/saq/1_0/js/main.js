...
formDefault = {
	...
	callRest: function (tmpVal) {
		/*
		var protCol = window.document.location.protocol;
		var host = window.document.location.host;
		var href = window.document.location.href;
		var pName = window.document.location.pathname;
		
		alert("protocol: " + protCol + "\nhost: " + host + "\nhref: " + href + "\npathname: " + pName);
		*/

		//var urlServer = $("input[id$='hidServerUrl']").val() + "restservice/rest/";
		//var urlServer = "http://localhost:8080/ROOT/restservice/rest/";
		var urlServer = "restservice/rest/";

		var strFncSuccess = "wsRelEmp.showAjaxSuccess";
		//var webMethod = urlServer + "_layouts/SAQ/ReleveEmploi/wsRelEmp.asmx/InfoUser";
		var webMethod = urlServer + tmpVal;
		this.valToRest = tmpVal;
		var parameters = null;
